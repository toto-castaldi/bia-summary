...
- [ ] **CLI-01**: User can run `bia-summary <file.pdf>` to process a single BIA report
- [ ] **CLI-02**: User can use `--dry-run` flag to preview markdown output without PDF conversion
